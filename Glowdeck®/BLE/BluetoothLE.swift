...
class BLE: NSObject, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    public var       txChar: CBCharacteristic! //  = CBCharacteristic()
    public var       rxChar: CBCharacteristic! //  = CBCharacteristic()
    ...
    public func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral, advertisementData: [String : Any], rssi RSSI: NSNumber) {
       ...
       // print("[CM] Found: \(peripheral.identifier.uuidString) (RSSI: \(RSSI))")
        ...
        let index = peripherals.index { $0.name == peripheral.name }
